	...
	<div>
		...
		<div id="container_connexion" class="ls-0_5">
			...
			*/
			...
			//on parcourt la bdd pour chercher l'existence du login mot et du mot de passe sa1s1s par l'internaute
			//et on range le résultat dans le tableau $data
			$sql = 'SELECT count(*) FROM membres WHERE id="'.mysql_escape_string($_POST['email']). "'
			AND md5='" .mysql_escape_string(md5($_POST['pass'])). '"';
